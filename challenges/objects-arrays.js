...
const tyr = {
  ...
  rawr: function () { return (`RAWERSRARARWERSARARARRRR!`) }
};
...
console.log(`${tyr.name} weighed ${tyr.weight}.`);

// What was the diet of a velociraptor?
console.log(`${velo.name} was ${velo.diet} in diet.`);

// How long was a stegosaurus?
console.log(`${steg.name} was ${steg.length} long.`);

// What time period did tyrannosaurus live in?
console.log(`${tyr.name} lived during the ${tyr.period} Period.`);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`Tyrannosaurus says ${tyr.rawr()}`);
...
const universities = [];
//assumes 'Uni' is at the beginning of the word and university names are capitalized. 
...
console.log(`Lower Case Animals: `, lowerCase); 
...
*/
const smallerPopulation = zooAnimals.filter((animal) => {
  if (animal.population < 5) {
    return animal;
  }
});

console.log(`Small Populations: `, smallerPopulation);//I assume this question was changed, but they didn't change the variable names.
